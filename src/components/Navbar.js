...
export default function Navbar() {
  return (
    <nav className=" lg:flex justify-between hidden w-full bg-[#F39F1F] 2xl:py-8 lg:py-5 pl-[16rem] pr-[5rem]">

      <ul className="flex justify-between w-[30rem] items-center">
